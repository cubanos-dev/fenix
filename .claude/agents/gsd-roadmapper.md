...
Reference full template: `/home/cubanos/projects/fenix/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/cubanos/projects/fenix/.claude/get-shit-done/templates/state.md`.
