...
Use template from `/home/cubanos/projects/fenix/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/cubanos/projects/fenix/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/cubanos/projects/fenix/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
