...
- **Global scope**: `/home/cubanos/projects/fenix/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/cubanos/projects/fenix/.claude/notes/`)
...
2. Glob `/home/cubanos/projects/fenix/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/cubanos/projects/fenix/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/cubanos/projects/fenix/.claude/notes/` — works in any directory
